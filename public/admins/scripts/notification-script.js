...
channel.bind('validasi-pembayaran-event', function (data) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            toastr['info'](
                'Pesanan ID. ' + pesanan_id + ' Menunggu Validasi Pembayaran <br/> <a href="/admin/pesanan/validasi-pembayaran">Lihat...</a>'
            );
        },
    });
});
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            toastr['info'](
                'Custom Pesanan ID. ' +
                    pesanan_id +
                    ' Menunggu Validasi Pembayaran <br/> <a href="/admin/custom-pesanan/validasi-pembayaran">Lihat...</a>'
            );
        },
    });
});
