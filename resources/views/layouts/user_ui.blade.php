            ...
            <div class="col-md-6 head-middle">
                @if (Request::is('/') || Request::is('produk/*'))
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addon1"><i id="search-icon" class="far fa-search"></i>
                        ...
                        <li id="keranjang">
                            @if (Auth::user()->keranjang()->where('type', 'reguler')->get()->count() > 0)
                                <span id="badge-keranjang"
                                    class="badge badge-primary badge-notif">{{ Auth::user()->keranjang()->where('type', 'reguler')->sum('jumlah') }}</span>
                            @endif
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-info">
                <div class="modal-header">
                    <button type="button" id="close-myModal4" class="close" data-dismiss="modal"
