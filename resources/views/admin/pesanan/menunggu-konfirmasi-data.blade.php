                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="pesanan-item">
                                    ...
                                    <ul style="list-style-type: none">
                                        <li>
                                            <h5 style="font-size: 14px; margin-left: -25px;"><b>{{ $pb->nama }}</b>
                                            </h5>
                                        </li>
                                        <li>
                                            <h5 style="font-size: 13px; margin-left: -25px; margin-top: 10px">
                                                {{ $pb->jumlah }} Barang x {{ number_format($pb->harga) }}</h5>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="ongkir-{{ $d->id }}"
                                        class="form-control input-number currency-input input-ongkir" placeholder=""
                                        aria-describedby="basic-addon1">
                                </div>
                            </div>
                        </div>

                        <button onclick="konfirmasi({{ $d->id }})" class="btn-konfirmasi-transaksi">
                            <h4 style="color: rgb(0, 173, 0)"><i class="far fa-check-circle"
                                    style="margin-right: 5px"></i> Konfirmasi</h4>
                        </button>
                        <button data-idpesanan="{{ $d->id }}" class="btn-batal-transaksi" data-toggle="modal"
                            data-target="#modal-batal">
                            <h4 style="color: red"><i class="far fa-times-circle" style="margin-right: 5px"></i>
                                Batalkan</h4>
                        </button>
                    </div>
                </div>
