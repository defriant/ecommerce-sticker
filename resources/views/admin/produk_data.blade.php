        ...
        <div style="display: flex;">
            ...
            <div style="">
                <ul style="list-style-type: none;">
                    ...
                    <li><button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                            data-target="#modal-update-produk" style="margin-top: 15px"
                            data-idproduk="{{ $d->id }}" {{-- data-upgambar="{{ asset('user/barang_img/'.$d->gambar) }}" --}}
                            data-upkategori="{{ $d->jenis }}" data-upnama="{{ $d->nama }}"
                            data-upharga="{{ $d->harga }}" data-upjenisstock="{{ $d->jenis_stock }}"
                            data-upstock="{{ $d->stock }}" data-updeskripsi="{{ $d->deskripsi }}"
