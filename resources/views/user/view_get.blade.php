                                    ...
                                    <div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated"
                                        ...
                                        <div class="rating1">
                                            @if ($data->stock > 0)
                                                ...
                                                <span style="font-size: 15px; padding-left: 7px;">{{ $data->stock }}
                                                    Unit</span>
                                        ...
                                        <div class="color-quality">
                                            <div class="color-quality-right">
                                                ...
                                                <div class="quantity">
                                                    ...
                                                    <input id="jumlah" type="text" name="jumlah" value="1"
                                                        class="jumlah" required="">
                                        ...
                                        <div class="occasion-cart">
                                            @if ($data->stock > 0)
                                                @guest
                                                    <a class="item_add hvr-outline-out button2" data-toggle="modal"
                                                        data-target="#myModal4" style="cursor: pointer"><i
                                                ...
                                                @endauth
                                            @else
                                                <h6 style="font-size: 15px"><i>Stock barang ini sedang habis, silahkan di
                                                        cek kembali
                                                        nanti</i></h6>
                                            @endif
                                        </div>
