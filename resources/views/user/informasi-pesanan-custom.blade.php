            ...
            <form id="form-pesan" action="/custom/pesanan-proses" method="POST">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="input-group" style="width: 80%">
                            ...
                            <span id="info-telp" style="font-size: 12px; color: #999"><i>* Nomor telepon yang bisa
                                    dihubungi</i></span>
                        </div>
                        <div class="input-group" style="width: 80%">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="checkout-left-basket" data-wow-delay=".5s"
                            ...
                            <ul>
                                ...
                                <li>Total <i class="far fa-info-circle" style="margin-left: 5px" data-toggle="tooltip"
                                        data-placement="right" title="Total harga belum termasuk ongkos kirim"></i>
                        ...
                        <div class="pembayaran">
                            <ul>
                                <li>
                                    <h5 style="font-size: 12px; margin-bottom: 7px; line-height: 20px;">Ongkir ditentukan
                                        setelah pesanan
                                        dikonfirmasi oleh admin.</h5>
                                </li>
                                <li>
                                    <h5 style="font-size: 12px; margin-bottom: 7px; line-height: 20px;">Lakukan pembayaran
                                        melalui transfer
                                        rekening bank.</h5>
                                </li>
                                <li>
                                    <h5 style="font-size: 12px; margin-bottom: 7px; line-height: 20px;">Screenshot atau foto
                                        bukti pembayaran.
                                    </h5>
                                </li>
                                <li>
                                    <h5 style="font-size: 12px; margin-bottom: 7px; line-height: 20px;">Upload bukti
                                        pembayaran, pastikan foto
                                        tidak buram.</h5>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row" style="margin-top: 75px;">
                    <div style="text-align: center;">
                        ...
                        <button id="submit-pesan" class="btn-bottom" type="button">
                            <h5>Lanjut <i class="fas fa-chevron-right" style="margin-left: 10px"></i></h5>
                        </button>
                    </div>
                </div>
            </form>
