        ...
        <div class="container">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-head">
                                <h5 style="font-size: 12px">
                                    ...
                                    {{ $p->type === 'custom' ? 'Custom Pesanan' : 'Pesanan' }}
                                </h5>
                                <h5 style="font-size: 12px; margin-left: 10px">{{ date('d M Y', strtotime($p->created_at)) }}
                                </h5>
                            ...
                            <div class="panel-body">
                                            ...
                                            <div class="col-xs-12 col-sm-6">
                                                <div class="pesanan-item">
                                                    ...
                                                    <ul style="list-style-type: none">
                                                        ...
                                                        <li>
                                                            <h5
                                                                style="font-size: 12px; margin-left: 10px; margin-top: 10px">
                                                                Rp
                                ...
                                <div class="col-xs-12">
                                    <div class="detail-transaksi">
                                        @if ($p->status == 'menunggu_konfirmasi')
                                            <button data-href="{{ '/pesanan/batal/' . $p->id }}"
                                                class="btn-batal-transaksi">
                                                <h5 style="color: red"><i class="far fa-times-circle"
                                                        style="margin-right: 5px"></i> Batalkan Pesanan</h5>
                                            </button>
                                        @endif
                                        @if ($p->status == 'tiba_di_tujuan')
                                            <button data-href="{{ '/pesanan/selesai/' . $p->id }}"
                                                class="btn-selesai-transaksi">
                                                <h5 style="color: rgb(0, 173, 0)"><i class="far fa-check-circle"
                                                        style="margin-right: 5px"></i> Pesanan Selesai</h5>
                                            </button>
                                        @endif
                                        <button data-href="{{ '/pesanan/' . $p->id }}" class="btn-detail-transaksi">
                                            <h5 style="color: black"><i class="far fa-info-circle"
                                                    style="margin-right: 5px"></i> Lihat Pesanan</h5>
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            @else
                <div style="text-align: center; color: #999 !important; margin-top: 150px; margin-bottom: 100px">
                    ...
                    <br>
                    <button class="btn-belanja">
                        <h5><i class="far fa-shopping-bag" style="margin-right: 5px"></i> Belanja sekarang</h5>
                    </button>
                </div>
            @endif
