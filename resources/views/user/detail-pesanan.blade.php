            ...
            <div class="pesanan-list">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="pesanan-item">
                                            ...
                                            <ul style="list-style-type: none">
                                                ...
                                                <li>
                                                    <h5 style="font-size: 12px; margin-left: 10px; margin-top: 10px">Rp
                                                        {{ number_format($pb->harga) }}</h5>
                                                </li>
                                                <li>
                                                    <h5 style="font-size: 12px; margin-left: 10px; margin-top: 10px">
                                                        {{ $pb->jumlah }} {{ $pb->jenis_stock }}</h5>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xs-12 col-md-4 detail-harga" id="detail-harga-{{ $data->id }}">
                            ...
                            <ul style="list-style-type: none; margin-bottom: 15px" id="detail-harga-barang">
                                    ...
                                    @foreach ($data->pesananbarang() as $pb)
                                        <li style="margin-bottom: 20px">
                                            <h5 style="font-size: 13px">
                                                ...
                                                <span>Rp {{ $pb->harga }} x {{ $pb->jumlah }} barang</span>
                                                <span style="float: right">Rp {{ number_format($pb->total) }}</span>
                                            </h5>
                                        </li>
                                    @endforeach
                                @endif
                                ...
                                <li style="margin-bottom: 10px">
                                    @if ($data->ongkir == null)
                                        <h5 style="font-size: 13px">
                                            <b>Ongkir</b>
                                            <i class="far fa-info-circle" style="margin-left: 5px" data-toggle="tooltip"
                                                data-placement="right"
                                                title="Ditentukan saat pesanan dikonfirmasi oleh admin"></i>
                        ...
                        <div class="col-xs-12 status-pesanan">
                            ...
                            <h4 style="text-align: center; color: orange; margin-top: 50px; margin-bottom: 30px;">STATUS
                                PESANAN</h4>
                ...
                <form id="form-bukti-pembayaran" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="pembayaran">
                            <ul>
                                <li>
                                    <h5 style="font-size: 12px; margin-bottom: 7px; margin-left: 7px;">Lakukan pembayaran
                                        transfer melalui rekening bank.</h5>
                                </li>
                                <li>
                                ...
                                <li>
                                    <h5 style="font-size: 12px; margin-bottom: 7px; margin-left: 7px;">Screenshot atau foto
                                        bukti pembayaran.</h5>
                                </li>
                                <li>
                                    <h5 style="font-size: 12px; margin-bottom: 7px; margin-left: 7px;">Upload bukti
                                        pembayaran, pastikan foto tidak buram.</h5>
                                </li>
                            </ul>
                        </div>
                        <img id="preview-bukti-pembayaran" src="" class="" width="100%" alt="">
                        <div class="" style="text-align: center">
                            <span id="foto-bukti-pembayaran-invalid" class="helper-text"
                                style="color: red; margin-top: 17px; display: none"><i>Pilih foto sebelum upload</i></span>
                            <button type="button" class="btn-pembayaran" style="margin-top: 10px"
                                onclick="document.getElementById('bukti-pembayaran-input').click()">Pilih Foto</button>
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input id="id-pesanan" type="hidden" name="id_pesanan" value="{{ $data->id }}">
                            <input id="bukti-pembayaran-input" type="file" name="bukti_pembayaran"
                                style="display: none">
                        </div>
                    </div>
