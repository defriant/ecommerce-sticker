...
use App\Traits\Admin\CustomGeneral;
use App\Traits\Admin\CustomPart;
use Pusher\Pusher;
use Auth;
use Session;
use Str;
...
class AdminController extends Controller
{
    ...
    // Custom
    public function custom_general()
    {
        return view('admin.customs.general');
    }
}
